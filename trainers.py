...
class CLTrainer(Trainer):
    ...
    def evaluate(
        ...
        params['classifier'] = {'nhid': nhid, 'optim': optim, 'batch_size': batch_size,
        ...
        metrics = {"eval_stsb_spearman": stsb_spearman, "eval_sickr_spearman": sickr_spearman, "eval_avg_sts": (STS12 + STS13 + STS14 + STS15 + STS16 + stsb_spearman + sickr_spearman) / 7, "STS12": STS12, "STS13": STS13,"STS14": STS14 , "STS15": STS15, "STS16": STS16}

        
        '''
        if eval_senteval_transfer or self.args.eval_transfer:
            avg_transfer = 0
            for task in ['MR', 'CR', 'SUBJ', 'MPQA', 'SST2', 'MRPC']:#, 'TREC'
